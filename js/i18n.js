(function () {
    ...
    const translations = {
        pt: {
            ...
            'companies.bbi.k2.desc': 'Analista de inteligência artificial proativo e multiagente, estruturado sobre um backbone de 3 camadas.',
            'companies.bbi.tailor.eyebrow': 'Visualização de dados',
            'companies.bbi.tailor.desc': 'Núcleo de visualização de dados remodelado para clientes da BBI, que integra dashboards do Tableau via trusted ticket.',
            'companies.bbi.livert.eyebrow': 'Audiovisual ao vivo',
            'companies.bbi.livert.desc': 'Central operacional com IA multimodal para monitoramento, transcrição e análise de audiência de livestreams minuto a minuto.',
            'companies.bbi.flux.eyebrow': 'Inteligência OOH',
            'companies.bbi.flux.desc': 'Plataforma de inteligência para OOH que calcula o alcance real e o perfil do público nas ruas, cruzando geolocalização, ANATEL e IBGE.',
            'companies.bbi.argus.eyebrow': 'Brand safety',
            'companies.bbi.argus.desc': 'SaaS de brand safety e auditoria de contexto para publishers: identifica anunciantes e classifica conteúdos via LLM multimodal.',
            'companies.bbi.hertz.eyebrow': 'Mídia radiofônica',
            'companies.bbi.hertz.desc': 'Infraestrutura que transforma rádio offline em mídia programática e líquida, auditada por IA de áudio 24/7 com registro em blockchain.',
            ...
            'companies.gl.paths.desc': 'Plataforma SaaS que transforma a gestão do desenvolvimento de pessoas e carreiras. Arquitetura modular oferecendo visibilidade, controle e eficiência da capacitação ao crescimento profissional dos colaboradores.',
            'companies.gl.tdplanner.eyebrow': 'Gestão de treinamentos',
            'companies.gl.tdplanner.title': 'TD Planner',
            'companies.gl.tdplanner.desc': 'Automatiza 100% do ciclo de planejamento, execução e certificação de treinamentos corporativos, reduzindo custos operacionais com gestão centralizada, ágil e eficiente.',
            'companies.gl.comprova.eyebrow': 'Avaliação de competências',
            'companies.gl.comprova.title': 'COMPROVA+',
            'companies.gl.comprova.desc': 'SaaS que automatiza a criação de questionários personalizados e gera relatórios analíticos detalhados — apoia decisões sobre talentos, mapeamento de gaps e sucessão em posições-chave.',
            'companies.gl.fabrica.eyebrow': 'Produção EAD',
            'companies.gl.fabrica.title': 'Fábrica de Conteúdo EAD',
            'companies.gl.fabrica.desc': 'Estrutura completa para converter treinamentos em experiências digitais — inteligência instrucional, recursos multimídia e integração corporativa para o conhecimento certo à pessoa certa na hora certa.',
            'companies.gl.immersive.eyebrow': 'VR / AR para treinamento',
            'companies.gl.immersive.title': 'Immersive Learn',
            'companies.gl.immersive.desc': 'Virtual Learning que transforma treinamentos complexos em experiências imersivas com realidade virtual, aumentada e simuladores. Ideal para conteúdos DICE (perigosos, raros, caros ou inviáveis).',
            'companies.gl.retention.eyebrow': 'IA para retenção',
            'companies.gl.retention.title': 'HR Retention Machine',
            'companies.gl.retention.desc': 'IA e ciência de dados que identificam riscos de desligamento, preveem padrões de rotatividade e orientam ações estratégicas de retenção — fortalecendo estabilidade e performance organizacional.',
            'companies.gl.datadriven.eyebrow': 'Cultura data-driven',
            'companies.gl.datadriven.title': 'Gestão Data-Driven',
            'companies.gl.datadriven.desc': 'Business Decision System completo: integração de dados, datalake, definição de KPIs, capacitação analítica e Business Decision Rooms com dashboards interativos para decisões ágeis e sustentáveis.',
            'companies.gl.ativos.eyebrow': 'Gestão de ativos',
            'companies.gl.ativos.title': 'Sistema Inteligente de Gestão de Ativos',
            'companies.gl.ativos.desc': 'Monitoramento e otimização do ciclo de vida de ativos integrando telemetria em tempo real, BI, dashboards e agentes de IA — da aquisição à revenda, maximizando valor residual.',
            'companies.gl.ppt.eyebrow': 'Operações & Manutenção',
            'companies.gl.ppt.title': 'Process Performance Tools (PPT)',
            'companies.gl.ppt.desc': 'Solução digital e consultiva que transforma manutenção e operação com modelos de excelência, inspeções estruturadas e monitoramento inteligente — garantindo disponibilidade, produtividade e segurança.',
            'companies.gl.pontosfortes.eyebrow': 'Liderança & psicometria',
            'companies.gl.pontosfortes.title': 'Gestão Pontos Fortes',
            'companies.gl.pontosfortes.desc': 'Modelo de gestão e liderança combinando psicometria de última geração, IA e Big Five para mapear personalidade, talentos e habilidades — potencializando desempenho individual, das equipes e da organização.',
            ...
            'companies.it.integracity.desc': 'Plataforma para reduzir o tempo de execução de tarefas em órgãos públicos, com acessibilidade cloud e segurança de dados como pilares. Hoje é o produto principal da nossa frente tech-pública.',
            'companies.it.cidades.tagline': 'Saúde pública orientada por dados',
            'companies.it.cidades.title': 'Cidades Saudáveis',
            'companies.it.cidades.desc': 'Programa que conecta dados de saúde pública e políticas urbanas para tornar municípios mais saudáveis — diagnóstico, KPIs e priorização de intervenção baseada em evidências.',
            'companies.it.fourhealth.tagline': 'Desenvolvimento humano integrado',
            'companies.it.fourhealth.title': '4Health',
            'companies.it.fourhealth.desc': 'Iniciativa de saúde integrativa baseada em dados e prevenção, conectando desenvolvimento humano, empregabilidade e empreendedorismo.',
            'companies.it.life.tagline': 'Desenvolvimento pessoal & profissional',
            'companies.it.life.title': 'Life Academy',
            'companies.it.life.desc': 'Iniciativa fundada em 2020 focada em desenvolvimento pessoal e profissional. 2500+ pessoas atendidas em workshops, mentorias e conteúdos sobre tecnologia, soft skills e empreendedorismo. Plataforma multilíngue.',
        ...
        en: {
            ...
            'companies.bbi.k2.desc': 'Proactive, multi-agent AI analyst structured on a 3-layer backbone.',
            'companies.bbi.tailor.eyebrow': 'Data visualization',
            'companies.bbi.tailor.desc': 'Data visualization core rebuilt for BBI clients, integrating Tableau dashboards via trusted ticket.',
            'companies.bbi.livert.eyebrow': 'Live audiovisual',
            'companies.bbi.livert.desc': 'Operational hub with multimodal AI for monitoring, transcribing, and analyzing livestream audiences minute by minute.',
            'companies.bbi.flux.eyebrow': 'OOH intelligence',
            'companies.bbi.flux.desc': 'Out-of-home intelligence platform that calculates real reach and audience profile on the streets, combining geolocation, ANATEL, and IBGE data.',
            'companies.bbi.argus.eyebrow': 'Brand safety',
            'companies.bbi.argus.desc': 'SaaS for brand safety and context auditing for publishers — identifies advertisers and classifies content via multimodal LLMs.',
            'companies.bbi.hertz.eyebrow': 'Radio media',
            'companies.bbi.hertz.desc': 'Infrastructure that turns offline radio into programmatic, liquid media — audited 24/7 by audio AI and recorded on blockchain.',
            ...
            'companies.gl.paths.title': 'Paths to Growth',
            'companies.gl.paths.desc': 'SaaS platform transforming people development and career management. Modular architecture offering visibility, control, and efficiency from training to professional growth.',
            'companies.gl.tdplanner.eyebrow': 'Training management',
            'companies.gl.tdplanner.title': 'TD Planner',
            'companies.gl.tdplanner.desc': 'Automates 100% of the planning, execution, and certification cycle of corporate training, reducing operational costs with centralized, agile management.',
            'companies.gl.comprova.eyebrow': 'Competency assessment',
            'companies.gl.comprova.title': 'COMPROVA+',
            'companies.gl.comprova.desc': 'SaaS that automates personalized questionnaire creation and generates detailed analytical reports — supporting decisions on talent, gap mapping, and succession in key positions.',
            'companies.gl.fabrica.eyebrow': 'EAD production',
            'companies.gl.fabrica.title': 'EAD Content Factory',
            'companies.gl.fabrica.desc': 'End-to-end structure to convert trainings into digital experiences — instructional intelligence, multimedia resources, and corporate integration for the right knowledge to the right person at the right time.',
            'companies.gl.immersive.eyebrow': 'VR / AR training',
            'companies.gl.immersive.title': 'Immersive Learn',
            'companies.gl.immersive.desc': 'Virtual Learning that turns complex training into immersive experiences with VR, AR, and simulators. Ideal for DICE content (Dangerous, Rare, Expensive, Infeasible).',
            'companies.gl.retention.eyebrow': 'AI for retention',
            'companies.gl.retention.title': 'HR Retention Machine',
            'companies.gl.retention.desc': 'AI and data science to identify exit risk, predict turnover patterns, and guide strategic retention actions — strengthening organizational stability and performance.',
            'companies.gl.datadriven.eyebrow': 'Data-driven culture',
            'companies.gl.datadriven.title': 'Data-Driven Management',
            'companies.gl.datadriven.desc': 'Complete Business Decision System: data integration, datalake, KPI definition, analytical capability building, and Business Decision Rooms with interactive dashboards for agile, sustainable decisions.',
            'companies.gl.ativos.eyebrow': 'Asset management',
            'companies.gl.ativos.title': 'Intelligent Asset Management System',
            'companies.gl.ativos.desc': 'Asset lifecycle monitoring and optimization integrating real-time telemetry, BI, dashboards, and AI agents — from acquisition to resale, maximizing residual value.',
            'companies.gl.ppt.eyebrow': 'Operations & maintenance',
            'companies.gl.ppt.title': 'Process Performance Tools (PPT)',
            'companies.gl.ppt.desc': 'Digital and consultative solution that transforms maintenance and operations with excellence models, structured inspections, and intelligent monitoring — ensuring uptime, productivity, and safety.',
            'companies.gl.pontosfortes.eyebrow': 'Leadership & psychometry',
            'companies.gl.pontosfortes.title': 'Strengths-Based Management',
            'companies.gl.pontosfortes.desc': 'Management and leadership model combining state-of-the-art psychometry, AI, and the Big Five to map personality, talents, and skills — boosting individual, team, and organizational performance.',
            ...
            'companies.it.integracity.title': 'IntegraCity',
            'companies.it.integracity.desc': 'Platform to reduce task execution time in public agencies, with cloud accessibility and data security as pillars. Today it is the lead product of our tech-for-public initiative.',
            'companies.it.cidades.tagline': 'Data-driven public health',
            'companies.it.cidades.title': 'Healthy Cities',
            'companies.it.cidades.desc': 'Program connecting public health data with urban policy to make municipalities healthier — diagnostics, KPIs, and evidence-based intervention prioritization.',
            'companies.it.fourhealth.tagline': 'Integrated human development',
            'companies.it.fourhealth.title': '4Health',
            'companies.it.fourhealth.desc': 'Integrative health initiative based on data and prevention, connecting human development, employability, and entrepreneurship.',
            'companies.it.life.tagline': 'Personal & professional growth',
            'companies.it.life.title': 'Life Academy',
            'companies.it.life.desc': 'Initiative founded in 2020 focused on personal and professional development. 2500+ people reached through workshops, mentoring, and content on technology, soft skills, and entrepreneurship. Multilingual platform.',
